...
let test_high_order_2 ctxt =
  ...
  assert_equal ~printer:string_of_int_list [4;6;5;7;6;8;2;4] @@ flat_map f1 x;
  assert_equal ~printer:string_of_int_list [4;6;5;7;6;8] @@ flat_map f1 y;
  assert_equal ~printer:string_of_int_list [6;8;4;6] @@ flat_map f1 z;
  assert_equal ~printer:string_of_int_list [2;4;4;6;7;9;9;11;8;10] @@ flat_map f1 a;
  assert_equal ~printer:string_of_int_list [2;4] @@ flat_map f1 b;
  assert_equal ~printer:string_of_int_list [] @@ flat_map f1 c;

  assert_equal ~printer:string_of_int_list (map (( * ) 2) x) @@ flat_map f2 x;
  assert_equal ~printer:string_of_int_list (map (( * ) 2) y) @@ flat_map f2 y;
  assert_equal ~printer:string_of_int_list (map (( * ) 2) z) @@ flat_map f2 z;
  assert_equal ~printer:string_of_int_list (map (( * ) 2) a) @@ flat_map f2 a;
  assert_equal ~printer:string_of_int_list (map (( * ) 2) b) @@ flat_map f2 b;
  assert_equal ~printer:string_of_int_list (map (( * ) 2) c) @@ flat_map f2 c
